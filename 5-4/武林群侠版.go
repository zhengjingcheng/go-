...
type Notifier1 interface {
	...
	//删除观察者
	RemoveListener(listener Listener1)
	//通知广播
	Notify(event *Event)
}
type Event struct {
...
func (hero *Hero) Fight(another Listener1, baixiao Notifier1) {
...
// 添加观察者
func (b *BaiXiao) AddListener(listener Listener1) {
	b.heroList = append(b.heroList, listener)
}

// 删除观察者
func (b *BaiXiao) RemoveListener(listener Listener1) {
